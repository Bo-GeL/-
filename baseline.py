...
for cell_index in cells:
    ...
    # Optimizer
    adam = Adam(learning_rate=0.01, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.1)
    ...
    model.save(f'../saved_nn_models/model_{model_num}/ORIG_NN_{precoder}_maxprod_cell_{cell_index}.keras')
